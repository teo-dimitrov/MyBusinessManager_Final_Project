...
overtimeForm.addEventListener("submit", handleCommentSubmit)
...
function asOvertime(o) {
    let commentHtml = `<div id="commentCntr-${o.overtimeId}">`
    commentHtml += `<h4>${o.user} (${o.created})</h4><br/>`
    commentHtml += `<textarea rows="3" class="form-control m-md-auto" readonly>${o.name}</textarea>`
    commentHtml += `</div>`
